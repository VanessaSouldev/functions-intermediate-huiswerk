...
for (i = 0; i < grades.length; i++) {
    ...
    sumTotalGrades = sumTotalGrades + grades[i];
}

console.log(sumTotalGrades / grades.length);
...
function averageGrade(arrayOfNumbers) {
    ...
    for (i = 0; i < arrayOfNumbers.length; i++) {
        ...
        sumTotalGrades = sumTotalGrades + arrayOfNumbers[i];
    }
    return (sumTotalGrades / arrayOfNumbers.length);
...
function highestGrade(arrayOfGrades) {
    ...
    for (let i = 0; i < arrayOfGrades.length; i++) {
        ...
        if (arrayOfGrades[i] > count) {
            count = arrayOfGrades[i];
        }
